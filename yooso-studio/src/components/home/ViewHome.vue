<!-- Not to be confused with [ViewHomeGeneral] which is reffered to
 as 'Home' in the admin UI. 'Home' is the main landing page for the
 application, the 'home' route of the 'ViewHome' component. -->
